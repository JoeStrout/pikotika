...
The 10 consonants are written with the letters you'd expect, and the sound in the middle column is the one to aim for.  But each letter really names a small *range* of sounds, and everything in the right-hand column is equally correct -- not merely tolerated, but correct.

| Letter | Say it like | Also correct |
|---|---|---|
| `p` | **p** in **p**in | **b** in **b**in |
| `t` | **t** in **t**op | **d** in **d**ot, or **th** in **th**is |
| `k` | **k** in **k**in | **g** in **g**o |
| `v` | **v** in **v**an | **f** in **f**an |
| `s` | **s** in **s**un | **z** in **z**oo, or **sh** in **sh**oe |
