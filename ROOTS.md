...
| and | kum | 并 | and, with, also, together, plus |
| if | kan | 可 | maybe, possible, chance, luck, condition |
| more | mas | 又 | more, again, comparative, extra, another |
| same | sam | 同 | same, equal, like, as, similar |
...
| able | pos | 能 | can, able, ability, skill, capable |
...
| two | pits | 2 | two, 2, pair, both |
| three | tets | 3 | three, 3 |
| four | wats | 4 | four, 4 |
| five | kins | 5 | five, 5 |
| six | siks | 6 | six, 6 |
...
| eight | ots | 8 | eight, 8 |
| nine | noks | 9 | nine, 9 |
| ten | tekas | 十 | ten, 10, tens place |
| hundred | katon | 百 | hundred, 100, hundreds place |
| thousand | kiru | 千 | thousand, 1000, thousands place |
...
| evening | vesper | 夕 | evening, night, dark part of day; west (`evening-side`) |
| week | seman | 週 | week, seven-day cycle |
| morning | matin | 朝 | morning, early day; east (`morning-side`) |
...
| Gloss | Latin | Han | Covers |
|---|---|---|---|
| word | verpo | 言 | word, language, speech, name, message, number |
| name | nomen | 名 | name, title, label |
| language | paror | 語 | language, tongue, dialect |

## People and society (14)

| Gloss | Latin | Han | Covers |
|---|---|---|---|
| self | eko | 己 | self, I, me, own, identity |
| you | tuo | 尔 | you, addressee |
| man | viro | 男 | male |
| woman | vema | 女 | female |
| child | nino | 子 | child, offspring, young of |
| parent | pari | 亲 | parent, ancestor |
| relative | kina | 氏 | relative, kin, extended family |
| friend | ami | 朋 | friend, companion, ally |
| law | reke | 法 | law, rule, permission, authority, government |
| money | moni | 贝 | money, price, cost, value, payment |
| country | nasyon | 国 | country, nation, state, homeland |
| marry | maris | 婚 | marry, spouse, wedded |
| crime | kirmen | 犯 | crime, theft, offense, illegal act |
| price | kosto | 価 | price, cost, fee, charge |

## Places, arts, appearance (8)

| Gloss | Latin | Han | Covers |
|---|---|---|---|
| home | kase | 户 | home, house, dwelling, household |
| shop | komer | 店 | shop, store, commercial establishment |
...
| hotel | oster | 宿 | hotel, inn, lodging |
...
| Gloss | Latin | Han | Covers |
|---|---|---|---|
| body | korpo | 体 | body, physical, flesh |
| head | testa | 头 | head, top, leader, chief |
| hand | manu | 手 | hand, arm, finger, grasp |
| leg | kampa | 足 | leg, foot, walking limb |
| life | viva | 生 | alive, live, birth, grow |
| sick | mara | 病 | ill, diseased, damaged, defective, hurting (pain = `sick-feel`) |
| heal | sana | 医 | heal, cure, medicine, health, repair |
| mouth | puka | 口 | mouth, lips, bodily opening |
| pain | torer | 苦 | pain, hurt, ache, suffering |
| taste | sapor | 味 | taste, flavor, savor |
| stomach | venter | 胃 | stomach, belly, gut, abdomen |
...
| Gloss | Latin | Han | Covers |
|---|---|---|---|
| tool | uter | 工 | tool, instrument, device, machine, utensil |
| cloth | ropa | 衣 | cloth, clothes, fabric, covering |
| box | vaso | 皿 | closed container: box, bag, bottle, case, vessel |
| paper | karta | 片 | paper, card, page, document, ticket |
| vehicle | karo | 车 | vehicle, car, craft, conveyance |
| door | porta | 門 | door, gate, entrance, portal |
| power | poten | 強 | power, force, strength, energy, effort-capacity |
| picture | pitur | 画 | picture, image, photo, drawing, film |
| electric | vorto | 電 | electric, electricity, electronic, powered |
| table | tapur | 机 | table, desk, counter, flat surface |
| room | kamar | 室 | room, chamber, interior space within a building |
| toilet | panyu | 便 | toilet, lavatory, restroom, bathroom, WC |
| key | yave | 錠 | key, lock, to lock or unlock |
...
| meal | senar | 飯 | meal, course, sitting |
...
| Gloss | Latin | Han | Covers |
|---|---|---|---|
| go | ire | 行 | go, move, travel, proceed |
| remain | sista | 止 | stop, halt, remain, cease, stand |
...
| put | seta | 安 | put, place, set, position |
...
| job | ravor | 労 | job, occupation, employment, career |
...
| wait | asper | 待 | wait, await, pause, stand by |
...
| hard | turus | 硬 | hard, firm, solid, rigid |
| clean | puru | 清 | clean, pure, washed |
| polite | kortes | 礼 | polite, courteous, respectful |
...
| bend | kurva | 弓 | bend, curve, turn, fold |
...
| shame | putor | 恥 | shame, embarrassment, humiliation |
| calm | seren | 和 | calm, relaxed, peaceful, quiet |
